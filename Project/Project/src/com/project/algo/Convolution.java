...
import com.project.algo.Util;
/** A layer that performs n convolutions. Uses ReLU for activation. */
public class Convolution implements PlateLayer {
    ...
    private Convolution(List<List<Plate>> convolutions) {
    ...
    public static class Builder {
        ...
        public Convolution build() {
            ...
            return new Convolution(convolutions);
        }
